...
/**
 * OVERLAY upstream Settings.
 * Добавлено: SUBSCRIPTION_DISCOUNTS в getVariables, чтобы frontend видел
 * ту же discount-map что и сервер.
 */
class Settings extends ModelController
{
    ...
    protected function getVariables(): array
    {
        return [
            ...
            // --- overlay-добавки ---
            // Discount-map для подписки. Format: "1:1.0,3:0.95,6:0.90,12:0.75"
            // Frontend читает эту строку и применяет ту же логику что сервер
            // (см. deploy/customizations/frontend/src/components/payment/subscription.vue).
            'SUBSCRIPTION_DISCOUNTS' => getenv('SUBSCRIPTION_DISCOUNTS') ?: '',
        ];
    }
