...
/**
 * OVERLAY upstream Level.
 * Изменён: costForPeriod применяет SubscriptionPricing discount-map
 * (SUBSCRIPTION_DISCOUNTS env-переменная).
 *
 * @property int $id
...
class Level extends Model
{
    ...
    public function costForPeriod(int $period = 1): float
    {
        ...
        // При пустом SUBSCRIPTION_DISCOUNTS поведение совпадает с upstream (multiplier=1.0).
        return SubscriptionPricing::calculate($this->price, $period);
    }
